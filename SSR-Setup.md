...
### 2 Supervisor Config anlegen
	...
	Inhalt:
	[program:inertia-ssr]
	directory=/var/www/korbitsch.at/current
	command=php artisan inertia:start-ssr
	autostart=true
	autorestart=true
	user=deployer
	redirect_stderr=true
	stdout_logfile=/var/www/korbitsch.at/shared/logs/inertia-ssr.log

### 3 Log-Verzeichnis erstellen

	mkdir -p /var/www/korbitsch.at/shared/storage/logs
    nano inertia-ssr.log --> save
